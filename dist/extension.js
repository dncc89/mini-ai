...
const nodeFetch = __webpack_require__(8)
...
/* harmony import */ var whatwg_url__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(12);
/* harmony import */ var https__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(10);
...
const punycode = __webpack_require__(18);
const tr46 = __webpack_require__(19);
...
const { TextDecoder } = __webpack_require__(5);
const { Writable } = __webpack_require__(6);
...
async function processAICommand(context, userInput) {
...
function generatePayload(text, userInput, isFill = false) {
...
function getTextBlock(document, position) {
    return document.lineAt(position.line).text;
}
const getChatCompletionStreaming = async (sendMessages, apiKey, gptmodel) => {
    try {
        let content = '';
